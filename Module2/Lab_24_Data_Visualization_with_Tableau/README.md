...
I added a Result filter on Win to display only one occurrence of each game instead of 2.
...
280 out of 1160 is a ratio of 1 to 4 so it is significant: game location has a remarkable influence over game result. 
...
Minnesota Vikings with a completion percentage of 70%.
